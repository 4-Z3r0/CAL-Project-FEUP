...
bool GraphViewer::defineEdgeDashed(bool dashed) {
	char buff[200];
	sprintf_s(buff, "defineEdgeDashed %s\n", dashed? "true" : "false");
	string str(buff);
	return con->sendMsg(str);
}
...
bool GraphViewer::setEdgeDashed(int k, bool dashed) {
	char buff[200];
	sprintf_s(buff, "setEdgeDashed %d %s\n", k, dashed? "true" : "false");
	string str(buff);
	return con->sendMsg(str);
}
...
bool GraphViewer::defineVertexIcon(string filepath) {
	char buff[200];
	sprintf_s(buff, "defineVertexIcon %s\n", filepath.c_str());
	string str(buff);
	return con->sendMsg(str);
}
...
bool GraphViewer::setVertexIcon(int k, string filepath) {
	char buff[200];
	sprintf_s(buff, "setVertexIcon %d %s\n", k, filepath.c_str());
	string str(buff);
	return con->sendMsg(str);
}
...
bool GraphViewer::defineVertexSize(int size) {
	char buff[200];
	sprintf_s(buff, "defineVertexSize %d\n", size);
	string str(buff);
	return con->sendMsg(str);
}
...
bool GraphViewer::setVertexSize(int k, int size) {
	char buff[200];
	sprintf_s(buff, "setVertexSize %d %d\n", k, size);
	string str(buff);
	return con->sendMsg(str);
}
...
bool GraphViewer::setEdgeWeight(int id, int weight) {
	char buff[200];
	sprintf_s(buff, "setEdgeWeight %d %d\n", id, weight);
	string str(buff);
	return con->sendMsg(str);
}
...
bool GraphViewer::setEdgeFlow(int id, int flow) {
	char buff[200];
	sprintf_s(buff, "setEdgeFlow %d %d\n", id, flow);
	string str(buff);
	return con->sendMsg(str);
}
